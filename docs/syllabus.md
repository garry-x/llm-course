...
| 推理工程 | Week 8 | Ch10 | KV Cache、continuous batching admission、long-context serving gate、quantization、FlashAttention、RAG、vLLM/SGLang、Triton、服务指标 |
...
| Ch10 | KV cache、排队、显存/带宽、压测统计、RAG 指标、long-context quality/cost、tool 协议和准入控制 | continuous batching admission、long-context serving gate、benchmark summary、P/D 解耦容量计划和上线报告 |
