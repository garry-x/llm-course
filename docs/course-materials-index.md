...
| 2026-06-05 | lecture note core pack | 新增 L2/L4/L6/L12/L15 高风险主题核心 notes，覆盖类比推理、RoPE、mask/CE、GQA/MLA、推测解码、来源边界和经典 NLP | `.venv/bin/python verify_course.py` |
