...
本作业对应第 10 章推理优化与工程落地。目标是实现 KV Cache、显存估算、INT8 量化、最小 RAG、检索质量指标、基准指标和 LSH 检索。
...
| Programming parts | 55 | 实现 KV cache、显存估算、INT8 量化、RAG/LSH、检索质量指标、benchmark 指标汇总和 metric card |
