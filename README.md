...
| 10 | **推理优化与前沿** — KV Cache/量化/RAG/Tool/MCP Gate/vLLM/Triton/生产发布/多模态 | KV Cache + 量化 + RAG + Tool/MCP Gate + rollout gate + overload response + continuous batching admission + P/D pool plan + speculative gate + LSH + 服务蓝图 | 11+5 |
