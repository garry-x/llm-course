...
(function(){
  ...
  var CHAPTERS = [
    ...
    {id:7, file:'ch07.html', title:'训练循环', desc:'数据管线、AdamW、scheduler、checkpoint、分布式、MFU 与训练成本', sections:19},
    ...
    {id:10, file:'ch10.html', title:'推理优化与前沿', desc:'KV Cache、量化、RAG、服务压测、模型发布包、多模态与推理引擎', sections:22},
