...
(function(){
  ...
  var CHAPTERS = [
    ...
    {id:3, file:'ch03.html', title:'Single-Head Self-Attention', navTitle:'Self-Attention', desc:'Scaled Dot-Product Attention, cross-attention, mask, diagnostics & complexity bounds', zhTitle:'单头自注意力', zhNavTitle:'自注意力', zhDesc:'Scaled Dot-Product Attention、cross-attention、mask、诊断与复杂度边界', sections:21},
    ...
    {id:8, file:'ch08.html', title:'Text Generation', navTitle:'Generation', desc:'Sampling, stop semantics, beam, reasoning budget & structured decoding', zhTitle:'文本生成', zhNavTitle:'文本生成', zhDesc:'采样、停止语义、beam、thinking budget 与结构化输出', sections:26},
