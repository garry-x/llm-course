...
Incorporates industrial-grade architecture cases such as MLA, MoE, GRPO/DAPO/GSPO, FP8, sparse/compressed attention, linear attention, SSM/Mamba-style sequence models, and learnable residual connections, using them to understand the engineering bottlenecks behind each component, rather than chasing the specifications of individual model versions.
...
| Memory & Bandwidth Optimization | Ch04, Ch10 | Calculate KV Cache, understand MQA/GQA/MLA, sparse/compressed attention, linear attention, SSM-style compact state, weight-only/W8A8/KV cache quantization, FlashAttention, and memory bottlenecks |
...
```
llm-course/
├── index.html                # Course homepage and chapter directory
...
│   └── ch01.html ~ ch11.html
├── docs/                     # Markdown sources and rendered HTML handouts
